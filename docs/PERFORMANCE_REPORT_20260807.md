...
- **4K60 noisy（08-08 低负载复测，loadavg≈1.9）：avg 145.9ms / max 193ms / p99 193ms（27 样本）**；
  丢包 ~2%（rx 135154 / tx 132413）、SFU CPU 4.9%——负载对延迟影响显著
- 40-80ms@4K60 正式验收仍待专用/干净环境（当前瓶颈为 VT 编码 + FFmpeg 软解 CPU，
  4K60 实际 ~24fps，观看端硬解接入见 #74 结论）
