...
use crate::ios::decode::H264Decoder;
...
use crate::ios::viewer::ViewerSession;
...
pub unsafe extern "C" fn ad_viewer_take_frame(
    ...
    unsafe { crate::ios::viewer::take_frame(&*v, out) }
}
...
pub unsafe extern "C" fn ad_viewer_take_audio(
    ...
    unsafe { crate::ios::viewer::take_audio(&*v, dst, max) }
}
